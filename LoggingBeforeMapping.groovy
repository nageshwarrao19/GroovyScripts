...
def Message processData(Message message) {
    ...
    if(messageLog != null && enable_log != 'FALSE'){
        messageLog.setStringProperty("LoggingBeforeMapping", "Printing Payload As Attachment")
        messageLog.addAttachmentAsString("2.Compound Employee Response (Before Mapping):", body, "text/xml");
     }
    return message;
}